...
```{r echo=FALSE, width=9, height=8, eval=FALSE, warning=FALSE, message=FALSE}
...
<center>
<iframe src="https://r-music.github.io/rday-2018/docs/chorrrds" width=100% height = 650 frameborder="0" scrolling="no" marginheight="0" marginwidth="0"> </iframe>
</center>
