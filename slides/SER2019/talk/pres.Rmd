...
- The systems can be provenient of the models we assume:
...
da <- read.table("talk/data/survey.txt", header = TRUE)
...
train =  pd.read_csv('talk/data/train.txt', sep=" ", header=0)
test =  pd.read_csv('talk/data/test.txt', sep=" ", header=0)
```
...
- **Spam filter**: how likely is an email to be a spam given its content?
...
library(RefManageR)
bibs <- ReadBib("talk/refs.bib", check = FALSE)
print(bibs, 
