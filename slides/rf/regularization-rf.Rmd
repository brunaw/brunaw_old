...
In shrinkage, the idea is to 'shrunk' the regression coefficients towards zero </b></p>
...
- The main goals of this presentention are to understand and 
...
the trees by considerating only a sample $m$ of the predictors as splitting 
...
is that feature importance plots can be constructed is a very easy way:
...
resulting in the fina lmeasure of importance for the random forest model.
